...
namespace Castle.Core.Tests
{
	...
	public class MixinTestCase : CoreBaseTestCase
	{
		...
		public void MixinForInterfaces()
		{
			...
			Assert.IsTrue(typeof(IMyInterface).GetTypeInfo().IsAssignableFrom(proxy.GetType()));
		...
		public void MixinImplementingMoreThanOneInterface()
		{
			...
			Assert.IsNotNull(proxy);
			Assert.IsTrue(typeof(SimpleClass).GetTypeInfo().IsAssignableFrom(proxy.GetType()));
		...
		public void SimpleMixin_InterfaceProxy_WithoutTarget()
		{
			...
			Assert.IsNotNull(proxy);
			Assert.IsTrue(typeof(IService).GetTypeInfo().IsAssignableFrom(proxy.GetType()));
