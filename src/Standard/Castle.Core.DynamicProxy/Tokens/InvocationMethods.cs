...
namespace Castle.DynamicProxy.Tokens
{
	public static class InvocationMethods
	{
		...
		public static readonly MethodInfo EnsureValidTarget =
			typeof(CompositionInvocation).GetTypeInfo().GetMethod("EnsureValidTarget", BindingFlags.Instance | BindingFlags.NonPublic);

		public static readonly MethodInfo GetArgumentValue =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("GetArgumentValue");

		public static readonly MethodInfo GetArguments =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("get_Arguments");

		public static readonly MethodInfo GetReturnValue =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("get_ReturnValue");
		...
		public static readonly MethodInfo Proceed =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("Proceed", BindingFlags.Instance | BindingFlags.Public);

		public static readonly FieldInfo ProxyObject =
			typeof(AbstractInvocation).GetTypeInfo().GetField("proxyObject", BindingFlags.Instance | BindingFlags.NonPublic);

		public static readonly MethodInfo SetArgumentValue =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("SetArgumentValue");

		public static readonly MethodInfo SetGenericMethodArguments =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("SetGenericMethodArguments", new[] {typeof(Type[])});

		public static readonly MethodInfo SetReturnValue =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("set_ReturnValue");

		public static readonly FieldInfo Target =
			typeof(CompositionInvocation).GetTypeInfo().GetField("target", BindingFlags.Instance | BindingFlags.NonPublic);

		public static readonly MethodInfo ThrowOnNoTarget =
			typeof(AbstractInvocation).GetTypeInfo().GetMethod("ThrowOnNoTarget", BindingFlags.Instance | BindingFlags.NonPublic);
	}
}