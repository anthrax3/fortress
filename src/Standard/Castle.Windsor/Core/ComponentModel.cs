...
namespace Castle.Windsor.Core
{
	public sealed class ComponentModel : GraphNode
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)] private IDictionary customDependencies;

		[DebuggerBrowsable(DebuggerBrowsableState.Never)] private DependencyModelCollection dependencies;

		[DebuggerBrowsable(DebuggerBrowsableState.Never)] private IDictionary extendedProperties;
