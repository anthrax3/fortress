...
namespace CastleTests
{
	...
	public class ConventionVerification
	{
		...
		{
			var fromInterface = interfaceMethod.GetCustomAttributes<TAttribute>().SingleOrDefault();
			var fromClass = classMethod.GetCustomAttributes<TAttribute>().SingleOrDefault();
