...
namespace Castle.Core.Tests
{
	...
	public class MultipleSavedAssembliesTestCase
	{
		...
		public void LoadAssemblyIntoCache_InvalidCacheAfterTwoLoadAssemblyIntoCacheThatContainsSameClass()
		{
			...
			//
			var proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "5", "ProxyCache5.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "5", "ProxyCache5.dll");
			...
			//
			proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "6", "ProxyCache6.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "6", "ProxyCache6.dll");
		...
		public void LoadAssemblyIntoCache_InvalidCacheAfterTwoLoadAssemblyIntoCacheThatContainsSameGeneric()
		{
			...
			//
			var proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "1", "ProxyCache1.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "1", "ProxyCache1.dll");
			var proxyBuilder = new DefaultProxyBuilder(proxyGeneratorModuleScope);
			var generator = new ProxyGenerator(proxyBuilder);
			...
			// note : to reproduce the problem, must load previously saved assembly (in cache) before saving this assembly.
			//
			proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "2", "ProxyCache2.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "2", "ProxyCache2.dll");
			proxyBuilder = new DefaultProxyBuilder(proxyGeneratorModuleScope);
			generator = new ProxyGenerator(proxyBuilder);
		...
		public void LoadAssemblyIntoCache_InvalidCacheAfterTwoLoadAssemblyIntoCacheThatContainsSameInterface()
		{
			...
			//
			var proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "3", "ProxyCache3.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "3", "ProxyCache3.dll");
			var proxyBuilder = new DefaultProxyBuilder(proxyGeneratorModuleScope);
			var generator = new ProxyGenerator(proxyBuilder);
			...
			// note : to reproduce the problem, must load previously saved assembly (in cache) before saving this assembly.
			//
			proxyGeneratorModuleScope = new ModuleScope(true, true, ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "4", "ProxyCache4.dll", ModuleScopeAssemblyNaming.GetCurrentAssemblyName() + "4", "ProxyCache4.dll");
			proxyBuilder = new DefaultProxyBuilder(proxyGeneratorModuleScope);
			generator = new ProxyGenerator(proxyBuilder);
