...
namespace Castle.Facilities.Logging
{
	...
	public class LoggingFacility : AbstractFacility
	{
        ...
        //@hikalkan: AppDomain is not supported by netstandard.
        //#if !SILVERLIGHT
        //		/// <summary>
		...
		private object[] GetLoggingFactoryArguments(Type loggerFactoryType)
		{
			...
			{
				ctor = loggerFactoryType.GetConstructor(new[] { typeof(bool) });
				if (ctor != null)
				{
			...
			if (configFile != null)
			{
				ctor = loggerFactoryType.GetConstructor(new[] { typeof(string) });
				if (ctor != null)
				{
			...
			if (level != null)
			{
				ctor = loggerFactoryType.GetConstructor(new[] { typeof(LoggerLevel) });
				if (ctor != null)
				{
					return new object[] { level.Value };
				}
			}
			ctor = loggerFactoryType.GetConstructor(Type.EmptyTypes);
			if (ctor != null)
			{
				return new object[0];
			}
